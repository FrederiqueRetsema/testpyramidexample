...
public class DrugDatabase {
   ...
   private static void loadDrugData() {
      ...
      drugsInDatabase.add(new DispensableDrug(1300, "fra", new EDrugClassification[] {EDrugClassification.ANALGESIC}));
      drugsInDatabase.add(new DispensableDrug(1400, "fra2", new EDrugClassification[] {EDrugClassification.ANALGESIC}));
   }
